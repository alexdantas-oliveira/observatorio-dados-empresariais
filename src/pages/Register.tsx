...
import { Loader2, BarChart3, Eye, EyeOff, ArrowRight, Check } from "lucide-react";
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-dark relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-40 left-10 w-80 h-80 bg-accent rounded-full blur-3xl" />
          <div className="absolute bottom-40 right-10 w-72 h-72 bg-primary rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          ...
          <h2 className="text-4xl font-bold mb-6 leading-tight">
            Junte-se à plataforma<br />
            <span className="text-gradient">de inteligência empresarial</span>
          </h2>
          
          <p className="text-lg text-white/80 mb-8 max-w-md">
            Crie sua conta e tenha acesso a dados estratégicos sobre o ecossistema 
            empresarial do Piauí.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/80">Dashboards interativos em tempo real</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center">
                <Check className="w-4 h-4 text-primary" />
              </div>
              <span className="text-white/80">Análises setoriais e geográficas</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center">
                <Check className="w-4 h-4 text-primary" />
              </div>
              <span className="text-white/80">Relatórios personalizados</span>
            </div>
          </div>
